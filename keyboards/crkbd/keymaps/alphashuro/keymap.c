...
//                                       //`--------------------------'  `--------------------------'
  ...
  //,---------------------
        LT(MOUSE, KC_TAB),    KC_Q,   KC_W,   KC_F,   KC_P,   KC_B,                KC_J,   KC_L,   KC_U,   KC_Y,   KC_COLN,    KC_BSPC,
        KC_LCTL,    KC_A,   KC_R,   KC_S,   KC_T,   KC_G,                           KC_M,   KC_N,   KC_E,   KC_I,   KC_O,       LT(FUN, KC_QUOT),
        KC_LSFT,    KC_Z,   KC_X,   KC_C,   KC_D,   KC_V,                           KC_K,   KC_H,KC_COMM,   KC_DOT, KC_SLSH,    KC_LSFT,
            LT(MEDIA, KC_ESC),  LGUI_T(KC_SPC),  LT(NAV, KC_SPC),  /*|*/  LT(SYM, KC_ENT), LT(NUM, KC_BSPC),   RALT(KC_DEL)
  ),
